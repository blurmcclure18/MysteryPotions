...
#define DATE "built on: Wed Jan 12 06:33:41 2022 UTC"
...
static const char compiler_flags[] = {
    ...
    'a','b','i',' ','-','I','/','h','o','m','e','/','a','l','e','c',
    '/','D','o','c','u','m','e','n','t','s','/','G','i','t','H','u',
    'b','/','M','y','s','t','e','r','y','P','o','t','i','o','n','s',
    '/','.','b','u','i','l','d','o','z','e','r','/','a','n','d','r',
    'o','i','d','/','p','l','a','t','f','o','r','m','/','b','u','i',
    'l','d','-','a','r','m','e','a','b','i','-','v','7','a','/','b',
    'u','i','l','d','/','p','y','t','h','o','n','-','i','n','s','t',
    'a','l','l','s','/','m','y','s','t','e','r','y','P','o','t','i',
    'o','n','s','/','i','n','c','l','u','d','e','/','p','y','t','h',
    'o','n','3','.','8','\0'
};
